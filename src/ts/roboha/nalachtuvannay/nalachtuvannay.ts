...
const SETTINGS_CONFIG = {
  1: { id: "toggle-shop", label: "Магазин _ Слюсар", class: "_shop" },
  2: { id: "toggle-receiver", label: "Приймальник", class: "_receiver" },
  3: { id: "toggle-income", label: "Джерело", class: "_income" },
};
